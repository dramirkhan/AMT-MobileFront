...
var apiUrl   = 'http://api.hcoder.net/api/index.php?token='+'5cff3ff0ed6ac-100143'+'&c=';
// private 5cff3ff0ed6ac-100143
// pulic 5a7d3fec77613-100001
//var apiUrl = 'https://newsapi.org/v2/top-headlines?country=us&apiKey=09f38fd0817948539d840bd426f92294';
		  
// https://newsapi.org/v2/sources?language=en&country=us&apiKey=09f38fd0817948539d840bd426f92294
// 远程服务端 http request 请求 从远程服务器收到数据放入导航栏 动态更新

// check login function  自己封装的函数

function checkLogin(){
	var suid = plus.storage.getItem('suid');
	var srand = plus.storage.getItem('srand');  // suid 存储用户本地数据 id  srand 存储随机码
	console.log(suid + ',,,' + srand);
	if (!suid || !srand){
		mui.openWindow({
			url:'login.html',
			id: 'login'
			});  // if not login we will open the login html automatically
